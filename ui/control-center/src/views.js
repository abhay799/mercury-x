...
export const VIEW_DEFINITIONS = Object.freeze([
  ['overview', 'Mission Control', '⌁'], ['workloads', 'Workloads', '◫'], ['graph', 'Execution Graph', '⌘'],
...
const renderers = { overview, workloads, graph: executionGraph, models: modelPrecision, memory: memoryContext, compute: computeFabric, slo: sloReasoning, migration: migrationRecovery, scheduler: schedulerIntelligence, federation: federationPrivacy, twin: digitalTwin, governance, evidence: evidenceAudit, system: systemStatus };
