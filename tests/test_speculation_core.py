...
def test_plan_is_bounded_and_winner_requires_verification():
    ...
    b1=SpeculativeBranch(branch_id="b1",placement_candidate_id="c1",state=SpeculativeBranchState.SUCCEEDED,result_id="r1",result_fingerprint="f1",verification_evidence_id="e1",verified=True)
    b2=SpeculativeBranch(branch_id="b2",placement_candidate_id="c2",state=SpeculativeBranchState.SUCCEEDED,result_id="r2",result_fingerprint="f2",verified=False)
